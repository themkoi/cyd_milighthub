...
namespace RichHttp {
  namespace Generics {
    ...
    template <class TConfig, class StringType>
    class EspressifRequestHandler : public ::RichHttp::Generics::BaseRequestHandler<TConfig, ::RequestHandler> {
      public:
        ...
        // Updated parameter types to match the base RequestHandler signatures in modern ESP32 Arduino Core
        ...
        virtual bool handle(typename TConfig::ServerType& server, HTTPMethod method, const String& uri) override {
